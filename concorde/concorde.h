...
int
    ...
    CCtsp_clique_delta (CCtsp_lpgraph *g, double *x, CCtsp_lpclique *c,
        double *delta),
    CCtsp_copy_lpcut_in (CCtsp_lpcut_in *c, CCtsp_lpcut_in *newa),
    ...
    CCtsp_lpcut_to_lpcut_in (CCtsp_lpcuts *cuts, CCtsp_lpcut *c,
        CCtsp_lpcut_in *newa),
    CCtsp_copy_lpclique (CCtsp_lpclique *c, CCtsp_lpclique *newa),
    CCtsp_copy_lpdomino (CCtsp_lpdomino *c, CCtsp_lpdomino *newa),
...
int
    CCtsp_copy_skeleton (CCtsp_skeleton *old, CCtsp_skeleton *newa),
...
int
    ...
    CCverify_classify (CCtsp_lpcut_in *cut, int check_types,
        CCverify_cutclass *classa);

void
    CCverify_initcutclass (CCverify_cutclass *classa),
    CCverify_freecutclass (CCverify_cutclass *classa);
